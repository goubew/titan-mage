...
- Change MP to Focus Points (used for special maneuvers, increased)
- Change ~() syntax to :
- Finish changing skills to feats
- Change character sheet for skills -> feats and MP to FP
- In weapon attack section, make unable to range attack with adjacent ally
- Turn initiative into an ability check
