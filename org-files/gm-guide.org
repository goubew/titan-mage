...
#+DESCRIPTION: Learn to become a game maven (GM) for the game of TitanMage TTRPG.
#+OPTIONS: toc:t toc:2

* Being A Game Maven

Every game needs a game maven (GM). The game maven is the arbiter of rules, the source of the game's content, and is someone that every player should be grateful for. More so than the players, the GM gets gets to flex their creativity and have the greatest involvement in the flow and feel of the game. If your game is missing a GM, then don't be afraid to try it out!

* About This Document

If you are unfamiliar with the game as a whole, reading through the Player's guide is important for being a GM. It is recommended to start there, then come back.

Unlike the Player's Guide, which is filled with hard rules, this document is more a launching point for your own work. It is your game after all.
...
When deciding how many shells or valuables to put into an adventure, use the character level table from the Player's Guide to decide. It's up to you to set a pace for how often the player's can level up, but in giving out enough treasure for one level per adventure is a good pace.
...
- Amenities: What can the players do in the town? They will need a place to sleep at least, but take a look at the *Town Features* section in the Player's Guide for some more ideas.
