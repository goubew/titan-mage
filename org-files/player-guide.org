...
Pure damage can not be reduced by any kind of defense. Pure damage is dealt by the dice portion of a normal [[* Weapon Attack][weapon attack]].
...
At the first level, mercenaries gain the *engage* minor action. This can be used when an enemy is within 5ft. Until the beginning of your next turn, if the enemy you target moves from their current position, you may take a free attack action during their turn as soon as they move. This effect lasts until you or the enemy moves at least 5ft.
...
At the fifteenth level, mercenaries gain the *rapid strike* class feature. If you kill an opponent with a weapon strike, you may take an extra major action. This feature can only be used once per turn.
