...
The highest clerics are called upon as undead specialists, uniquely equipped to handle vicious life stealing monsters and to sanctify the areas of the world that have been tainted by dark magics.

TODO: Make feats
Knowledge - Theology: Ability to identify religious and cultic symbols
Knowledge - Medicine: Ability to identify diseases and apply first aid
Holy Aura: Immunity to sickness and disease, even magical
Diplomacy: Advantage on ability checks when attempting to parlay
Divine Blessing: Advantage on ability checks to save from an effect
Lay on Hands: Heal someone as if they had used a respite dice without actually expending it
Prophecy: Once a week, can commune to glean information about what is happening in the world
Quiet Magic: Ability to cast spells quietly
...
TODO: Make feats
Animal reflexes: Advantage on initiative checks
Navigation: Advantage on check for not getting lost
Wilderness sense: Advantage on checks to avoid notice in wilderness
Multishot: Reload two bolts at once and make two ranged attacks with the attack action
Ambushing: Gain advantage on attacks against surprised opponents,
Natural Camouflage: Spent an hour to hide someone in a wilderness environment become visually indistinguishable while you are still
Alertness: Advantage on checks to hear noises and avoid surprise,
Climbing: You are proficient at climbing vertical surfaces without equipment or aid,
Mapping: You are proficient at recreating complicated maps from memory and are able to interpret detailed maps that others create,
Naturalism: Recognize common plants and animals. Identify animal calls, and poisonous foods, and strange behaviors,
Precise Shooting: Gain the ability to target foes that are adjacent to an ally with a ranged weapon attack,
Riding: Knowledge about the care and training of draft animals allows you to better evaluate the condition of animals and to make attacks from a mounted position without disadvantage,
Seafaring: Gain the ability to navigate and sail simple seafaring vessels,
Trapping: Knowledge of pits, deadfalls, and snares allows construction of traps for creatures up to the large size
...
#+begin_cw
#+HTML: <p><a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/">Game on</a></p>
#+end_cw
