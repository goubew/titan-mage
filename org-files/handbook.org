...
Characters with a [[* Combat Equipment][shield]] equipped can use this minor action to turn pure damage into defense damage and gain the [[* Defense][defense]] bonus from the shield.
