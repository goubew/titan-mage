...
Character level starts at 1 and goes up to 16. In order to level up, characters need to spend time and money in [[* Towns][town]]. The monetary price to level up does not include living expenses. TODO
