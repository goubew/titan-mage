...
Time spent training allows you to [[* Character Level][level up]]. See the level up table for the time ranges and costs.
...
Combat equipment includes weapons, armor, helms, and shields. Only one set of armor and helm can be worn at a time. Two one-handed combat items or one two-handed combat items can be worn at a time.

Switching held equipment, that is equipment that is not worn, can done with the [[*** Swapping Held Items][swapping held items]] minor action.
