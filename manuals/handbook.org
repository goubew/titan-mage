...
- Guard major action: Increases defense gained
...
Defense provides flat damage reduction. Certain abilities are able to ignore defense entirely and are marked as "ignores defense".
...
At the ninth level, tacticians gain the *minor shot calling* minor action. This lets another player character take a minor action during your turn instead of you. You decide who and which minor action, but the other player must agree with your choice. They cannot take the same minor action the next time they take their turn.

At the eleventh level, tacticians gain the *major shot calling* major action. This lets another player character take a major action during your turn instead of you. You decide who and which major action, but the other player must agree with your choice. They cannot take the same major action the next time they take their turn.
...
At the third level, mercenaries gain the *relentless lock* class feature. This lets you and allies gain [[* Power][power]] / 4 (calculated from your power stat) extra damage when targeting enemies that you have engaged. If the enemy moves away from you, this bonus no longer applies.
...
At the seventh level, mercenaries gain the *en guarde* class feature. [[* Power][power]] / 4 times per [[* Full Recovery][full recovery]], when your [[* Health Points (HP)][HP]] is reduced to 0, it remains at 1 instead.
...
At the third level, assassins gain the *sneaky strike* class feature. This let assassins add [[* Reflex][reflex]] / 2 to crit rolls against enemies when an ally is within 1 square of the enemy.
...
At the fifth level, assassins gain the *back stab* class feature. This lets assassins add [[* Reflex][reflex]] / 4 damage to attacks against enemies who have no allies within one square.
...
At the eleventh level, assassins gain the *rapid strike* class feature. If you kill an opponent with a weapon strike, you make take an extra major action. This feature can only be used once per turn.
...
At the eleventh level, scholars gain the *recycle* class feature. Gain [[* Focus][focus]] / 2 [[* Magic Power (MP)][MP]] every time your spell damages an enemy during your turn.

At the thirteenth level, scholars gain the *pre-emptive magic* major action. This lets you cast the spell learned from spell insight for zero mana this turn.
