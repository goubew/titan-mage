...
Magic resistance provides flat magic damage reduction. Magic threshold is rare, and is not provided by any normal armors. There is no magic resistance threshold, the reduction is always applied.
...
Whenever a weapon attack is made, roll a d20. If your roll [[* Presence][presence]] stat is equal or higher than the roll, double the damage of the attack.
...
Damage dealt by weapons is counted as physical damage and can be reduced by the [[* Defense][defense]] stat. Damage dealt by spells is counted as magical damage and can be reduced by the [[* Magic Resistance][magic resistance]] stat.
...
Arcane studies allows you to detect [[* Artifacts][artifacts]] and to decipher their effects. Without this, you will have to pay a hopefully trusted expert.

Arcane studies requires 1,000 shells to learn.
