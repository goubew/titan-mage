...
It is recomended to have two sets per player so that multidice rolls can occur at once.
...
Movement speed is a measure how how fast your character is. In [[* Combat][combat]], your character is allowed to move up to their movement speed in squares every round.
...
A respite requires an uninterupted rest of at least 4 hours. Spending 8 or more hours resting does not increase the resources gained. A respite can only occur once a day.
...
*** Spirit Caller
Spirit Callers hold a spiritual bond with their ancestors. In death, the titans retain the ability to influence the world through the favor given by the spirits of the departed. Spirit Callers call upon their presecesors to vouch for them.
