...
At the eleventh level, tacticians gain the *shot calling* major action. This lets another character take a major action during your turn instead of you. You decide which major action, but they must agree.
