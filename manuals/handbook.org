...
At the thirteenth level, tacticians gain the *high ground advantage* class feature. Attacks against enemies at a lower elevation deal [[* Presence][presence]] / 4 extra damage.
...
At the first level, mercenaries gain the *engage* minor action. This can be used when an enemy is within 1 square. Until the beginning of your next turn, if the enemy you target moves from their square, you may take a free attack action during their turn as soon as they move.

At the third level, mercenaries gain the *relentless lock* class feature. This lets allies gain [[* Power][power]] / 4 (calculated from your power stat) extra damage when targeting enemies that you have engaged. If the enemy moves away from you, this bonus no longer applies.
...
At the seventh level, mercenaries gain the *en guarde* class feature. Once per [[* Full Recovery][full recovery]], the first time your [[* Health Points (HP)][HP]] is reduced to 0, it remains at 1.
...
At the thirteenth level, mercenaries gain the *charge* minor action. This lets you move [[* Power][power]] / 4 extra squares during your move action, as long as your movement is a straight line. You can use *shove* as a free action if an enemy stands at the end of your charge.
...
At the first level, assassins gain the *leg sweep* minor action. This action puts an enemy into the [[* Fallen][fallen]] state if their reflex is less than yours.

At the third level, assassins gain the *down and out* class feature. This let assassins add 10 to crit rolls against enemies who are [[* Fallen][fallen]].

At the fifth level, assassins gain the *back stab* class feature. This lets assassins add their weapon attack dice instead of subtracting them when attacking an opponent with no allies within one square.

At the seventh level, assassins gain the *flourish strike* class feature. This let you take an extra minor action whenever you perform a critical weapon attack. This feature can only be used once per turn.

At the ninth level, assassins gain the *armor exploit* class feature. Assassins add [[* Reflex][reflex]] / 4 defense pierce to their weapon attacks.

At the eleventh level, assassins gain the *disarm* major action. An opponent within one square has a held weapon sent flying two squares away from you in any direction you choose.

At the thirteenth level, assassins gain the *rapid strike* class feature. If you kill an opponent with a weapon strike, you make take an extra major action. THis feature can only be used once per turn.
...
At the first level, scholars gain the *rest enjoyer* class feature. This allows the scholar to gain [[* Focus][focus]] / 4 extra HP or MP during a [[* Respite][respite]].

At the third level, scholars gain the *spell insight* minor action. This lets you identify the next spell that an enemy will cast.
...
At the seventh level, scholars gain the *spell imprint* minor action. If you cast a spell last turn, it can be cast again as a minor action.

At the ninth level, scholars gain the *magic guard* minor action. Gain [[* Focus][focus]] / 4 defense until the start of your next turn. This defense applies to magic damage as well as physical damage.

At the eleventh level, scholars gain the *improved magic guard* class feature. The defense gained from magic guard become active all of the time. As a minor action, you can give another player the same guard defense value until the start of your next turn.

At the thirteenth level, scholars gain the *pre-emptive magic* major action. This lets you cast the spell learned from spell imprint for zero mana this turn.

At the fifteenth level, scholars gain the *recycle* class feature. Gain [[* Focus][focus]] / 4 mana every time your spell damages an enemy during your turn.

At the sixteenth level, scholars gain the *spell chain* class feature. If a sorcerer kills an enemy with a spell, they may cast a different spell in the same major action.
